...
describe('Calculating rounded values', () => {
    ...
    it('Should be 3 (w/ negative) in and 5 values with 1.1 diff', () => {
        expect(Helper.getRoundedValues([-1, 0, 1]))
            .toStrictEqual([-1.2, -0.6, 0, 0.6, 1.2])
    })
    ...
    it('Should be 4 in and 5 values with 3 diff', () => {
        expect(Helper.getRoundedValues([0, 8, 5.2, 11]))
    ...
    it('Should be 80 in (w/0 zero value) and 5 values with 456,030 diff. 78 positive values and only 1 positive small value', () => {
        expect(Helper.getRoundedValues([1.00,
            -736.00,
            -648.00,
            -2376.00,
            ...
            -100.00,
            0.00]))
            .toStrictEqual([-1368090, -912060, -456030, 0, 456030])
    })
})